This contains the source code associated with the bachelor thesis "" by Silver Schnur. SWI-Prolog version 7.2.3 and Python 3.5.2 were used to develop the tester.
